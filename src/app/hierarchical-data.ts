...
export const tasks: Task[] = [
  {
    ...
    end: new Date('2015-10-12T00:00:00.000Z'),
    completionRatio: 0.45708333333333334,
    subtasks: [
      {
        id: 18,
        title: 'Project Kickoff',
        start: new Date('2014-06-02T09:00:00.000Z'),
      ...
      },
      {
        ...
        title: 'Research',
        start: new Date('2014-06-02T00:00:00.000Z'),
        end: new Date('2014-07-07T00:00:00.000Z'),
        ...
        subtasks: [
          ...
          },
          {
            ...
            start: new Date('2014-06-02T00:00:00.000Z'),
            end: new Date('2014-09-03T02:00:00.000Z'),
      ...
      },
      {
        ...
        end: new Date('2015-03-14T00:00:00.000Z'),
        completionRatio: 0.6,
        subtasks: [
          {
            id: 22,
            title: 'UI Design',
            start: new Date('2014-06-09T00:00:00.000Z'),
            end: new Date('2015-01-11T00:00:00.000Z'),
      ...
      },
      {
        ...
        start: new Date('2014-06-11T00:00:00.000Z'),
        end: new Date('2015-05-02T00:00:00.000Z'),
        ...
        subtasks: [
          {
            ...
            title: 'Prototype',
            start: new Date('2014-06-11T00:00:00.000Z'),
            end: new Date('2015-05-17T00:00:00.000Z'),
            completionRatio: 0.77,
          },
          {
            id: 26,
        ...
        subtasks: [
          {
            ...
            start: new Date('2014-06-30T00:00:00.000Z'),
            end: new Date('2014-12-05T00:00:00.000Z'),
